...
* После дедлайна из вашего репозитория берется последний успешный коммит,
  и проводится его тестирование на закрытом наборе файлов.
...
3. Сделать свой проект закрытым (private), в противном случае за это задание вам
   присуждается 0 баллов
4. Скопировать проект себе на компьютер (git clone)
5. Собрать шаблон
6. Реализовать архиватор
7. Загрузить итоговую версию в свой репозиторий на GitLab (git push)
